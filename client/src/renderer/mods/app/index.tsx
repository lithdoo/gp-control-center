...
export class AppLauncher extends FocusItem {
    app: AppBase
    ...
    constructor(appbase: AppBase) {
        super()
        this.app = appbase
        this[FocusAction.ENTER] = () => {
            this.app.start({})
            app.start(this.app.keyName, {})
            return null
        }
    }
}
...
export class AppCenter {
    ...
    regist(app: AppBase) {
        ...
        this.launchers = this.launchers.concat([new AppLauncher(app)])
    }
